...
class AVOLNet(AVC):
    ...
    def get_vision_subnetwork(self):
        return Sequential([
            ...
            Conv2D(filters=64, kernel_size=3, strides=2, padding='same', use_bias=False, name='vision_conv1_1'),
            BatchNormalization(name='vision_batch_norm1_1'),
            ReLU(name='vision_relu1_1'),
            Conv2D(filters=64, kernel_size=3, padding='same', use_bias=False, name='vision_conv1_2'),
            BatchNormalization(name='vision_batch_norm1_2'),
            ReLU(name='vision_relu1_2'),
            MaxPool2D(2, name='vision_pool1'),

            Conv2D(filters=128, kernel_size=3, padding='same', use_bias=False, name='vision_conv2_1'),
            BatchNormalization(name='vision_batch_norm2_1'),
            ReLU(name='vision_relu2_1'),
            Conv2D(filters=128, kernel_size=3, padding='same', use_bias=False, name='vision_conv2_2'),
            BatchNormalization(name='vision_batch_norm2_2'),
            ReLU(name='vision_relu2_2'),
            MaxPool2D(2, name='vision_pool2'),

            Conv2D(filters=256, kernel_size=3, padding='same', use_bias=False, name='vision_conv3_1'),
            BatchNormalization(name='vision_batch_norm3_1'),
            ReLU(name='vision_relu3_1'),
            Conv2D(filters=256, kernel_size=3, padding='same', use_bias=False, name='vision_conv3_2'),
            BatchNormalization(name='vision_batch_norm3_2'),
            ReLU(name='vision_relu3_2'),
            MaxPool2D(2, name='vision_pool3'),

            Conv2D(filters=512, kernel_size=3, padding='same', use_bias=False, name='vision_conv4_1'),
            BatchNormalization(name='vision_batch_norm4_1'),
            ReLU(name='vision_relu4_1'),
            Conv2D(filters=512, kernel_size=3, padding='same', use_bias=False, name='vision_conv4_2'),
            BatchNormalization(name='vision_batch_norm4_2'),
            ReLU(name='vision_relu4_2'),

            Conv2D(filters=128, kernel_size=1, padding='same', name='vision_conv5'),
            ReLU(name='vision_relu5'),
            Conv2D(filters=128, kernel_size=1, padding='same', name='vision_conv6')])

    def get_audio_subnetwork(self):
        return Sequential([
            InputLayer((257, 200, 1), name='audio_input'),

            Conv2D(filters=64, kernel_size=3, strides=2, padding='same', use_bias=False, name='audio_conv1_1'),
            BatchNormalization(name='audio_batch_norm1_1'),
            ReLU(name='audio_relu1_1'),
            Conv2D(filters=64, kernel_size=3, padding='same', use_bias=False, name='audio_conv1_2'),
            BatchNormalization(name='audio_batch_norm1_2'),
            ReLU(name='audio_relu1_2'),
            MaxPool2D(2, name='audio_pool1'),

            Conv2D(filters=128, kernel_size=3, padding='same', use_bias=False, name='audio_conv2_1'),
            BatchNormalization(name='audio_batch_norm2_1'),
            ReLU(name='audio_relu2_1'),
            Conv2D(filters=128, kernel_size=3, padding='same', use_bias=False, name='audio_conv2_2'),
            BatchNormalization(name='audio_batch_norm2_2'),
            ReLU(name='audio_relu2_2'),
            MaxPool2D(2, name='audio_pool2'),

            Conv2D(filters=256, kernel_size=3, padding='same', use_bias=False, name='audio_conv3_1'),
            BatchNormalization(name='audio_batch_norm3_1'),
            ReLU(name='audio_relu3_1'),
            Conv2D(filters=256, kernel_size=3, padding='same', use_bias=False, name='audio_conv3_2'),
            BatchNormalization(name='audio_batch_norm3_2'),
            ReLU(name='audio_relu3_2'),
            MaxPool2D(2, name='audio_pool3'),

            Conv2D(filters=512, kernel_size=3, padding='same', use_bias=False, name='audio_conv4_1'),
            BatchNormalization(name='audio_batch_norm4_1'),
            ReLU(name='audio_relu4_1'),
            Conv2D(filters=512, kernel_size=3, padding='same', use_bias=False, name='audio_conv4_2'),
